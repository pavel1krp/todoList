...
beforeEach(()=>{
    ...
    tasks ={
        ...
        [todolistID2]: [
            {description: 'string', title: 'string', completed: true, status: TaskStatuses.Completed, priority: TaskPriorities.Low, startDate: 'string', deadline: 'string', id: '1', todoListId: 'string', order: 0, addedDate: 'string'},
            {description: 'string', title: 'STRONG', completed: true, status: TaskStatuses.Completed, priority: TaskPriorities.Low, startDate: 'string', deadline: 'string', id: '2', todoListId: 'string', order: 0, addedDate: 'string'},
