...
export const changeTaskTitleAC = (listId: string, taskId: string, title: string) => ({type: 'CHANGE-TITLE', listId, taskId, title}) as const
...
export const changeIdDoneAC = (todoListId: string, taskId: string, done: boolean) => ({type: "CHANGE-IS-DONE", todoListId, taskId, done}) as const
